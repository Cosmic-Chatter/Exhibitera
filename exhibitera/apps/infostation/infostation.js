...
function loadDefinition (definition) {
  ...
  root.style.setProperty('--header-color', '#243447')
  root.style.setProperty('--footer-color', '#243447')
  root.style.setProperty('--section-header-color', '#f5f5f0')
  root.style.setProperty('--section-background-color', '#2f3e4f')
