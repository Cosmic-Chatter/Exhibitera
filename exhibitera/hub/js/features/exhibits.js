...
async function populateComponentDefinitionList (definitions, permission) {
  ...
  for (const uuid of sortedByName) {
    ...
    if (permission === 'edit' || permission === 'edit_content') {
      ...
      if (['image_compare', 'media_browser', 'media_player', 'timelapse_viewer', 'timeline_explorer', 'voting_kiosk', 'word_cloud_input', 'word_cloud_viewer'].includes(definition.app)) {
